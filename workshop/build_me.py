...
l2 = [
	...
	'./public/open-search-alerting/index.html',
	'./public/open-search-alerting/1_getting_started.html',
...
l3 = [
	...
	'./public/open-search-alerting/1_getting_started/aws_event.html',
	'./public/open-search-alerting/1_getting_started/self_paced.html',
	'./public/open-search-alerting/2_environment_set_up/cloudformation_automated.html',
	'./public/open-search-alerting/2_environment_set_up/create_index.html'
]
...
for html_file in l1:
	...
	with open(html_file, "r+") as html_object:
		...
		c5 = re.sub(r'<a href="./open-search-alerting/"', '<a href="./open-search-alerting/index.html"', c4)
		
		c6 = re.sub(r'<a class="nav nav-next" href="./open-search-log-analytics/"', '<a class="nav nav-next" href="./open-search-log-analytics/index.html"', c5)
...
for html_file in l2:
	...
	with open(html_file, "r+") as html_object:
		...
		html_object_6 = re.sub(r'<a href=\'..\/\'>OpenSearch Log Analytics Workshop</a> > 2. CloudWatch Log Collection', '<a href=\'../index.html\'>OpenSearch Log Analytics Workshop</a> > CloudWatch Log Collection', html_object_5)
		html_object_7 = re.sub(r'<a href=\'..\/\'>OpenSearch Log Analytics Workshop</a> > 1. OpenSearch Log Analytics', '<a href=\'../index.html\'>OpenSearch Log Analytics Workshop</a> > OpenSearch Log Analytics', html_object_6)

		html_object_8 = re.sub(r'<a href=\'..\/\'>OpenSearch Log Analytics Workshop</a> > <a href=\'../open-search-log-analytics/\'>1. OpenSearch Log Analytics</a> > 1. Getting started', '<a href=\'../index.html\'>OpenSearch Log Analytics Workshop</a> > <a href=\'../open-search-log-analytics/index.html\'>OpenSearch Log Analytics</a> > 1. Getting started', html_object_7)
		html_object_9 = re.sub(r'<a href=\'..\/\'>OpenSearch Log Analytics Workshop</a> > <a href=\'../collect-log-cloud-watch/\'>2. CloudWatch Log Collection</a> > 1. Getting started', '<a href=\'../index.html\'>OpenSearch Log Analytics Workshop</a> > <a href=\'../collect-log-cloud-watch/index.html\'>CloudWatch Log Collection</a> > 1. Getting started', html_object_8)

		html_object_10 = re.sub(r'> 1. Getting started', '> Getting started', html_object_9)

		html_object_11 = re.sub(r'> <a href=\'../open-search-log-analytics/\'>1. OpenSearch Log Analytics</a>', '> <a href=\'../open-search-log-analytics/index.html\'>OpenSearch Log Analytics</a>', html_object_10)
		html_object_12 = re.sub(r'> 2. Environment Set Up', '> Environment Set Up', html_object_11)

		html_object_13 = re.sub(r'> 3. Send Log Data to Kinesis Fire Hose', '> Send Log Data to Kinesis Fire Hose', html_object_12)
		html_object_14 = re.sub(r'Analytics</a> > 5. Clean Up', 'Analytics</a> > Clean Up', html_object_13)

		html_object_15 = re.sub(r'Analytics</a> > 5. Clean Up', 'Analytics</a> > Clean Up', html_object_14)

		html_object_16 = re.sub(r'> <a href=\'../open-search-log-analytics/\'>1. OpenSearch Log Analytics</a>', '> <a href=\'../open-search-log-analytics/index.html\'>OpenSearch Log Analytics</a>', html_object_15)
		html_object_17 = re.sub(r'> 4. Visualize and Analyze', '> Visualize and Analyze', html_object_16)

		html_object_18 = re.sub(r'> <a href=\'../collect-log-cloud-watch/\'>2. CloudWatch Log Collection</a>', '> <a href=\'../collect-log-cloud-watch/index.html\'>CloudWatch Log Collection</a>', html_object_17)

		html_object_19 = re.sub(r'> 3. Send Log Data to OpenSearch', '> Send Log Data to OpenSearch', html_object_18)
		html_object_20 = re.sub(r'> 4. Search Logs', '> Search Logs', html_object_19)

		html_object_21 = re.sub(r'> 5. Clean Up', '> Clean Up', html_object_20)		

		html_object.write(html_object_21)
		html_object.truncate()
